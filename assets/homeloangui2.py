...
def moreinfo():
    ...
    window3.geometry ("700x720")#Set the window siza
    ...
    photo6 = tk.PhotoImage (file = "Picture6.png")#Insert a picture
...
title2 = Label(window, text = ('By jiashiuuuu 2021~') , font = ('Bahnschrift Light Condensed', 14), background="white smoke", foreground="midnight blue")
title2.place(x=700, y=670)
