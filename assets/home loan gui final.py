...
def moreinfo():
    ...
    window3.title ("Introduction to Home Loan")
    window3.geometry ("700x720")
    window3.maxsize (700,720)
    window3.configure (bg='floral white')
    window3.attributes('-alpha', 0.93)
    ...
    photo6 = tk.PhotoImage (file = "Picture6.png")
    lblgambar6 = tk.Label (window3, image= photo6, relief ="flat", borderwidth=2)
    lblgambar6.place (x=490, y=60, width=180, height=180)
    
    T = Text( window3, height = 9, width = 58)
    ...
    photo7 = tk.PhotoImage (file = "Picture7.png")
    ...
    photo8 = tk.PhotoImage (file = "Picture9.png")
    lblgambar8 = tk.Label (window3, image= photo8, relief ="flat", borderwidth=2)
    lblgambar8.place (x=500, y=490, width=180, height=180)
...
def usermanual():
    ...
    window2.geometry ("700x720")
    window2.maxsize (700,720)
    ...
    photo11 = tk.PhotoImage (file = "Picture11.png")
    lblgambar10 = tk.Label (window2, image= photo11, relief ="sunken", anchor="center")
    lblgambar10.place (x=60, y=390, width=540, height=323)
   
    window2.mainloop()
    
def txt():
    receipt.configure(state='normal')
    messagebox.showinfo("Reminder","Your txt file will save at the same folder (location) of your python file.")
    cur_inp = receipt.get("1.0",END)
    f = open("Home Loan Receipt.txt","w")
    f.write(cur_inp)
...
def cal( Loan, rate, year):
    ...
    button3.place(x= 480, y=670, width= 200, height= 35)
...
window.maxsize (900,720)
window.configure (bg='white smoke')
window.attributes('-alpha', 0.9)
window.protocol("WM_DELETE_WINDOW", end_)

photopre =tk.PhotoImage (file = "calculator2.png")
lblgambarpre = Label (window, image=photopre, relief ="flat", borderwidth=0)
lblgambarpre.place (x=510, y=3, width=50, height=50)

photopre2 =tk.PhotoImage (file = "loan.png")
lblgambarpre2 = Label (window, image=photopre2, relief ="flat", borderwidth=0)
lblgambarpre2.place (x=70, y=0, width=100, height=110)

photo1 =tk.PhotoImage (file = "Picture5.png")
lblgambar = Label (window, image=photo1, relief ="flat", borderwidth=0)
lblgambar.place (x=710, y=50, width=180, height=180)

photo2 = tk.PhotoImage (file = "Picture3.png")
lblgambar2 = Label (window, image=photo2, relief ="flat", borderwidth=2)
lblgambar2.place (x=700, y=250, width=180, height=180)

photo3 = tk.PhotoImage (file = "Picture4.png")
lblgambar3 = Label (window, image=photo3, relief ="flat", borderwidth=2)
lblgambar3.place (x=700, y=450, width=180, height=180)

clockUI = Label(window, font = ('Bahnschrift Light Condensed', 14), background="white smoke",foreground="midnight blue")
clockUI.place(x=250, y= 50, width = 250, height = 40)
time()

title = Label(window, text = ('Home Loan Calculator') , font = ('Milkyroad', 20,"underline"), background="white smoke", foreground="midnight blue")
title.place(x=170, y=10)
...
property_value.place(x=270, y=105)

DownPayment = Entry(window)
DownPayment.place(x=270, y=145)

Rate = Entry(window)
Rate.place(x=270, y=185)

Year = Entry(window)
Year.place(x=270, y=225)

style = ttk.Style()
style.configure("CadetBlue3.TLabel",foreground="floral white",background="CadetBlue3",anchor="center",font=("agency fb", 14,'bold'))
...
button1.place(x= 490, y=130, width= 140, height= 35)

style = ttk.Style()
style.configure("orchid2.TLabel",foreground="floral white",background="orchid2",anchor="center",font=("agency fb", 14,'bold'))

button2 = Button(window, text = "↷     Reset  ", style="orchid2.TLabel",command= reset )
button2.config (state = NORMAL ,cursor="hand2")
button2.place(x= 490, y=180, width= 140, height= 35)
...
style = ttk.Style()
style.configure("orchid1.TLabel",foreground="floral white",background="khaki3",anchor="center",font=("Arial Rounded MT Bold", 10))
...
button4.place(x= 460, y=80, width= 220, height= 35)

style = ttk.Style()
style.configure("gold.TLabel",foreground="floral white",background="deep sky blue",anchor="center",font=("agency fb", 14,'bold'))
